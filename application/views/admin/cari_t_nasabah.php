            ...
            <div class="col-12 col-md-8 col-lg-12 order-3 order-md-2">
                ...
                <div class="card">
                    <h5 class="card-header">
                        <div class="row">
                            <div class="col-md-9">
                                <form action="<?= base_url('Admin/print_t_nasabah') ?>" method="post" target="_blank">
                                    <div class="row">
                                        <div class="col-md-3" hidden>
                                            <input type="text" class="form-control" id="searchInput" name="no_rekening" value="<?= $_GET['no_rek'] ?>">
                                        </div>
                                        <div class="col-md-3" hidden>
                                            <input type="date" class="form-control" id="searchInput" name="darip" value="<?= $_GET['dari'] ?>">
                                        </div>
                                        <div class="col-md-3" hidden>
                                            <input type="date" class="form-control" id="searchInput" name="sampaip" value="<?= $_GET['sampai'] ?>">
                                        </div>
                                        <div class="col-md-2">
                                            <button type="submit" class="btn btn-info" id="searchInput">Print</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
