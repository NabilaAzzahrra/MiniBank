        ...
        <div class="row">
            <div class="col-12 col-md-8 col-lg-12 order-3 order-md-2">
                <div class="card " style="padding-left: 40px; padding-right: 40px; padding-top: 20px; padding-bottom: 20px;">
                    <form action="<?= base_url('Admin/act_menabung') ?>" method="post">
                        <!-- <div class="mb-2">
                        ...
                        <div class="form-group" name="status">
                            <label>Jumlah Menabung</label>
                            <input type="number" name="jumlah_menabung" class="form-control" placeholder="Jumlah Menabung">
                        </div>
