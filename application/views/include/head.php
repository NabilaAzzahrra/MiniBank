...
<html
  ...
  data-assets-path="<?= base_url('assets/templates') ?>/assets/"
...
>
  <head>
    ...
    <!-- Versi Free (Gratis) -->
    <script src="https://use.fontawesome.com/releases/vVERSION/js/all.js" data-mutate-approach="sync"></script>  </head>
